...
class UScriptStruct* FActorMaterials::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorMaterials.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorMaterials, (UObject*)Z_Construct_UPackage__Script_QOL_Extension(), TEXT("ActorMaterials"));
	}
...
template<> QOL_EXTENSION_API UScriptStruct* StaticStruct<FActorMaterials>()
{
	...
	UQOL_ExtensionWidget::UQOL_ExtensionWidget(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UQOL_ExtensionWidget);
	UQOL_ExtensionWidget::~UQOL_ExtensionWidget() {}
	struct Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UQOL_ExtensionWidget, UQOL_ExtensionWidget::StaticClass, TEXT("UQOL_ExtensionWidget"), &Z_Registration_Info_UClass_UQOL_ExtensionWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQOL_ExtensionWidget), 3029511460U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_848676559(TEXT("/Script/QOL_Extension"),
		Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QOL_UE_build_Plugins_QOL_Extension_Source_QOL_Extension_Public_EditorUtilityWidget_QOL_ExtensionWidget_h_Statics::ScriptStructInfo),
		nullptr, 0);
